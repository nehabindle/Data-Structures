...
# -*- coding: utf-8 -*-
"""
Created on Thu Jan 31 16:15:49 2019
...
class singleLinkedList:
 ...
 #X is in the first node, so new node will be inserted in the beginning of the list
...
while True:
      ...
      print("4.Insert in an empty list/Insert in the beginning of list")
      print("5.Insert in a node at the end of list")
      print("6.Insert in a node after a specified node")
      print("7.Insert in a node before a specified node")
      print("8.Insert in a node at a given position")
      ...
      if option==1:
          ...
          data=int(input("Enter the element to be inserted in the beginning:"))
          list.insert_in_beginning(data)
      elif option==5:
          data=int(input("Enter the element to be inserted in the end:"))
